...
#define PanSource	"lab-05-q1.pml"
...
#define _nstates1	25	/* philosopher */
#define minseq1	9
#define maxseq1	32
#define _endstate1	24

#define _nstates0	10	/* :init: */
#define minseq0	0
#define maxseq0	8
#define _endstate0	9
...
#define Air1	(sizeof(P1) - Offsetof(P1, high) - 1*sizeof(int))
